...
class ZoneAlbumNotification extends JLNotificationRenderer {
		...
		switch ($data['type']) {
			case "postAlbum":
				...
				if(!empty($images)){
					...
					$strImage = '<span class="floatR"><span class="wd-fr-albimg"></span><span class="wd-fr-img"><img src="'.ZoneRouter::CDNUrl("/upload/gallery/fill/50-50/{$images[0]->image}").'" width="47" height="47" class="wd-jr" alt=""></span></span>';
				}
