...
class ZoneArticleNotification extends JLNotificationRenderer {
		...
		switch ($data['type']) {
			case "postArticle":
				...
				$message = $strImage.'<div class="of_1">
						...
						<p class="wd-posttime"><span class="wd-icon-16 wd-icon-create-toppic-ntf"></span><span class="timeago" title="'.$data['created'].'"></span></p>
					</div>';
