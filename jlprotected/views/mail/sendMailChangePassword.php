...
<tbody><tr>
	<td style="padding:10px;">
	 ...
	 <p style="font-family:'helvetica neue', Arial, Helvetica, sans-serif; color: #666; font-weight:200; font-size: 14px; text-align:center; padding:0px; margin:5px 0px 10px 0px;"><a style="color:#65d0c4;" href="http://youlook.net/contactUs">Let us know if this email was sent in error by clicking here!</a> </p>
	 </td>
</tr>
</tbody></table>
<?php endif; ?>
