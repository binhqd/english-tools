					...
					<tbody>
						...
						<tr>
							...
							<td style=" width:50%;padding:7px 10px 7px 5px; border-right: 1px solid #e6e6e6;  text-align:right;">
								<span style="font-family:'helvetica neue', Arial, Helvetica, sans-serif; color: #ccc; font-weight:200; font-size: 12px; text-align:right; text-transform: uppercase;">LOCATION</span>
							</td>
							<td style=" width:50%;padding:7px 5px 7px 10px; ">
								<span style="font-family:'helvetica neue', Arial, Helvetica, sans-serif; color: #999; font-weight:200; font-size: 14px; text-align:left;"><?php echo strip_tags(MyZoneHelper::formatLocation($data['profile']['location'],""));?></span>
							</td>
						</tr>
					</tbody>
				</table>
