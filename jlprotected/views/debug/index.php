...
.wd-right-content{float:right;width:100%;padding-left:10px;vertical-align:top;background:#fff;font-size:10px;}
.wd-main-content{vertical-align:top;height:100%;background:#fff;}
		...
		<div class="wd-center">
			<div class="wd-right-content" id="rightContent">
				...
				<div class='debugTab trace watches'>
					<h2 class='title'>Watches: (<a href='/debug/clean'>Clean</a>)</h2>
					<?php 
					$cnt = 0;
					...
					<div class='code-block <?php echo !$hasCode ? "string" : ""?>'>
						<?php if($hasCode): ?>
							...
							<div class="minus">–</div>
						<?php endif; ?>
						<?php CVarDumper::dump($item[0], 100, true);?>
						<?php if($item[2]): ?>
						<?php echo $item[1];?>
						<?php endif;?>
					</div>
