					...
					<div class="wd-topleft-person">
						<div class="wd-primary-avatar custom-avatar-upload wd-primary-avatar-upload">
							<a
								...
								<img id="avatarChange" src="<?php echo ZoneRouter::createUrl("/upload/user-photos/{$user->hexID}/fill/147-147/{$mainAvatar->image}?album_id={$user->hexID}")?>" alt="<?php echo $user->displayname?>">
							</a>
						...
						?>
							...
							<div class="step4">
								<a class="wd-syncphoto-avatar js-button-sync-photo" href="<?php echo ZoneRouter::createUrl('/facebook/checkPhotoPermission'); ?>">
									<span class="wd-icon-face-sync"></span>
									<span class="wd-text-3">Last updated on <span class="timeago" title="<?php echo date(DATE_ISO8601, $user->profile->lastsyncfbphotos); ?>">
									<img src="<?php echo baseUrl();?>/img/front/ajax-loader.gif" alt="loading" style="width:14px;">
									</span></span>
				...
				<div class="wd-profile-action-top">
					<div class="wd-profile-action-top-content">
						...
						<div class="wd-leftcontent">
							<a class="wd-close-topmess wd-close-top2" target="wd-profile-action-top"></a>
							...
							<fieldset class="wd-topsearch-pagelet-form">
								<div class="wd-input-search">
									<form action="<?php echo GNRouter::createUrl('/friends/list/find'); ?>" method="GET">
										<input type="text" class="wd-text-search" name="keyword" placeholder="Search...">
