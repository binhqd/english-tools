				...
				<div class="wd-main-content">
					...
					<div class="wd-sync-your-photo">
						...
						<div class="wd-last-update js-last-update-photo">
							...
							<p>Last updated on <span class="timeago" title="<?php echo date(DATE_ISO8601, $user->profile->lastsyncfbphotos); ?>"><?php echo date('Y-m-d H:i:s', $user->profile->lastsyncfbphotos); ?></span></p>
							<?php endif; ?>
