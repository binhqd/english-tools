...
Yii::setPathOfAlias('rules', $strMyZonePath . '/../../jlruntime/rules');
...
// Webroot
Yii::setPathOfAlias('jlwebroot', dirname(__FILE__) . "/../../../wwwroot/jlwebroot");
Yii::setPathOfAlias('myzonewebroot', dirname(__FILE__) . "/../../../wwwroot/jlwebroot");
