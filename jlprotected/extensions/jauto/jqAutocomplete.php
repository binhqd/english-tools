...
class jqAutocomplete extends CComponent
{
	...
	protected static function defaultOptions(){
		$config = array(
			...
			'showAnimSpeed'	=> '',	// the duration of the show animation, see http://api.jquery.com/animate/
			'showAnimEasing'	=> '',// The easing function to use for the show animation 
			...
			'hideAnimSpeed'	=> '', // hide animation duration, see http://api.jquery.com/animate/
			'hideAnimEasing'=> '' // The easing function to use for the hide animation 
									// (linear or swing when using jquery only, see http://gsgd.co.uk/sandbox/jquery/easing/ for more easing functions)
		);	
