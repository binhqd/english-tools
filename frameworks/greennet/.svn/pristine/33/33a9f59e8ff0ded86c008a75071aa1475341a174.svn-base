...
class GNDoChangeEmailAction extends CAction {
	...
	public function run()
	{
		...
		try {
			...
			$backUrl = GNRouter::createUrl('/profile');
			$message = 'Your email has successfully changed to ' . $request->new_email;
