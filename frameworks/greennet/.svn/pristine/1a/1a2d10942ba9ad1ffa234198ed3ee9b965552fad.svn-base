...
// 		{
// 			if (isset($this->scriptGroup[parent::POS_HEAD]) && count($this->scriptGroup[parent::POS_HEAD]) !==  0)
// 			{
// 				foreach ($this->scriptGroup[parent::POS_HEAD] as $dir => $jsFiles) {
// 					$this->combineAndCompress('js', $jsFiles, parent::POS_HEAD, $dir);
// 				}
// 			}
			
// 			if (count($this->cssFiles) !==  0)
// 			{
// 				foreach ($this->cssGroup as $media => $cssGroup) {
// 					foreach ($cssGroup as $dir => $cssFiles) {
// 						$this->combineAndCompress('css', $cssFiles, $media, $dir);
// 					}
// 				}
// 			}
// 		}
