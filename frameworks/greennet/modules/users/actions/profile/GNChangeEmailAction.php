...
class GNChangeEmailAction extends CAction {
	...
	public function run()
	{
		...
		try {
			...
			if (empty($codeChangeEmail)) throw new Exception('Cannot create confirmation code');
			...
			$subject = "Change email request confirmation";
			$message = $strLink;
			...
			$messageNotify = 'The system has sent you a confirmation email for confirming change email.<br/>Please check your email to continue.';
