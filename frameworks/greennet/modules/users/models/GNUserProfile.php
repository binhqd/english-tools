 ...
 */
class GNUserProfile extends GNActiveRecord
{
	...
	/**
	 * This method is used to return profile data as an array
	 * @return array $attributes
	 */
	public function toArray() {
		$attributes = $this->attributes;
		$attributes['id'] = IDHelper::uuidFromBinary($attributes['id'], true);
	...
	public function afterSave($event = null) {
		...
		// Remove from cache
		$strUserID = IDHelper::uuidFromBinary($this->user_id, true);
		GNUser::model()->deleteCache($strUserID);
