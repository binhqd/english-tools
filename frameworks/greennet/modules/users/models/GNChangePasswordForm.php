...
class GNChangePasswordForm extends GNFormModel
{
	...
	public function checkOldPassword($attribute, $params)
	{
		...
		if ($strPassword != $currentUser->password) {
			$this->addError($attribute, UsersModule::t('The current password is incorrect.'));
			return false;
		} else {
			return true;
		}
	...
	{
		return array(
			'currentPassword' => UsersModule::t('Current Password'),
			'password' => UsersModule::t('New Password'),
			'confirmPassword' => UsersModule::t('Confirm New Password'),
		);
	}
